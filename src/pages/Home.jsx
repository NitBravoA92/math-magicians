  ...
  <Layout>
    <section id="home">
      ...
      <div className="page-content">
        ...
        <p className="home-info">
          Calculators are a fundamental part of our lives and most of us have to use them at one point or another. 
          Those people who are highly dependent on calculators can reduce their dependency by switching to using an online 
